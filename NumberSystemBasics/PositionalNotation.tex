    ...
    \subsection{二进制的衍生进制}\label{subsec:NumberSystemBasics/PositionalNotation/BinaryDerivation}
        ...
        \begin{table}
            ...
            \begin{tabular}{|c|l|l|l|l|l|l|}
                ...
                LGP-30\tablefootnote{\cite[Hexadecimal Digits.]{lgp-30-manual}，\textit{很可能}是命令表格上的字母\cite[Summary of Orders]{lgp-30-manual}\cite[The Command Table]{lgp-30-advertisement}占用后，再去掉诸如数字 0 与大写英文字母 O、数字 1 与小写英文字母 l 等剩下的列表。} & \texttt{f} & \texttt{g} & \texttt{j} & \texttt{k} & \texttt{q} & \texttt{l} \\ \hline
