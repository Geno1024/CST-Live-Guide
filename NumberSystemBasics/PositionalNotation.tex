        ...
        \begin{savenotes}
            \begin{table}
                ...
                \begin{tabular}{|c|l|l|l|l|l|l|}
                    ...
                    LGP-30\footnote{\cite[Hexadecimal Digits.]{lgp-30-manual}，这个字母的选择\textit{很可能}是命令表格上的字母\cite[Summary of Orders]{lgp-30-manual}\cite[The Command Table]{lgp-30-advertisement}占用后，再去掉诸如数字 0 与大写英文字母 O、数字 1 与小写英文字母 l 等剩下的列表。} & f & g & j & k & q & l \\ \hline
