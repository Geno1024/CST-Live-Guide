    ...
    \subsection{二进制的衍生进制}\label{subsec:NumberSystemBasics/PositionalNotation/BinaryDerivation}
        ...
        \begin{table}
            ...
            \begin{tabular}{|c|l|l|l|l|l|l|}
                ...
                IBM System/360\tablefootnote{\cite[APPENDIX E: HEXADECIMAL-DECIMAL NUMBER CONVERSION TABLE]{ibm-360-assembler-language}} & \texttt{A} & \texttt{B} & \texttt{C} & \texttt{D} & \texttt{E} & \texttt{F} \\ \hline
                ...
                PDS 1020\tablefootnote{\cite[Table of Printout Abbreviations]{pds1020-guide}，似乎是使用 LDS、CPY、ADD、SUB、MPY、DIV 六个可以在键盘\cite[Data Flow In The PDS 1020 Computer]{pds1020-guide}上直接输入的指令的首字母。} & L & C & A & S & M & D \\ \hline
                % TODO: 把 cite 中提到的其它计算机都补上
            \end{tabular}
