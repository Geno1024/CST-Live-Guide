\section{浮点数}\label{sec:NumberSystemBasics/floating-point}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw (2, -0.2) -- (2, -1.2) -- (4, -1.2);
            \draw (6.5, -0.2) -- (6.5, -1.2) -- (4.5, -1.2);
            \node at (4.25, -1.2) {6};

            \draw (2.5, -0.2) -- (2.5, -1.6) -- (4.5, -1.6);
            \draw (7, -0.2) -- (7, -1.6) -- (5, -1.6);
            \node at (4.75, -1.6) {5};

            \draw (3, 0.7) -- (3, 0.9) -- (5, 0.9);
            \draw (7.5, 0.7) -- (7.5, 0.9) -- (5.5, 0.9);
            \node at (5.25, 0.9) {4};

            \draw (3.5, 1.1) -- (3.5, 1.3) -- (5.5, 1.3);
            \draw (8, 1.1) -- (8, 1.3) -- (6, 1.3);
            \node at (5.75, 1.3) {3};

            \draw (4, 1.5) -- (4, 1.7) -- (6, 1.7);
            \draw (8.5, 1.5) -- (8.5, 1.7) -- (6.5, 1.7);
            \node at (6.25, 1.7) {2};

            \draw (4.5, 1.9) -- (4.5, 2.1) -- (6.5, 2.1);
            \draw (9, 1.9) -- (9, 2.1) -- (7, 2.1);
            \node at (6.75, 2.1) {1};
        \end{tikzpicture}
        \caption{存储位在数轴上的位置}
