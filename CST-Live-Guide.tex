...
% https://tex.stackexchange.com/a/10133/149813
    ...
    \subfile{ArithBasics/intro}
    \subfile{ArithBasics/positional-notation}
    \subfile{ArithBasics/positional-notation-presentation}
    \subfile{ArithBasics/positional-notation-conversion}
    \subfile{ArithBasics/floating-point}
    \subfile{ArithBasics/non-positional}
