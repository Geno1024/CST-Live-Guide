...
% https://tex.stackexchange.com/a/10133/149813
    ...
    \subfile{Preface/Intro.tex}
    \subfile{Preface/NoAIGC.tex}
    \subfile{Preface/WritingGuideline.tex}
    ...
    \subfile{Preclass/Intro.tex}
    \subfile{Preclass/SolvingQuestions.tex}
    \subfile{Preclass/Sitting.tex}
    \subfile{Preclass/English.tex}

    \subfile{LogicAndInference/Intro}
    \subfile{LogicAndInference/Syllogism}
    ...
    \subfile{NumberSystemBasics/NonPositional}

%    \subfile{Logic/Intro}
%    \subfile{Logic/WhatIsLogic}
%    \subfile{Logic/Beginning}

%    \subfile{Calculations/Intro}
%    \subfile{Calculations/OperationBasics}
%    \subfile{Calculations/ElementaryArithmetic}
%    \subfile{Calculations/BooleanAlgebra}

    \subfile{RainbowAndColorSpace/Intro}
